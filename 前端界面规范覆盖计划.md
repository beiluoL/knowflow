...
|---|---|---|---|---|---|
| `views/LearningPaths.vue` | 1207 | 2 | ✅ | P0 | 死按钮×2、缺 focus |
| `views/PathDetail.vue` | 1213 | 0 | ✅ | P0 | 缺 focus |
| `views/Challenge.vue` | 378 | 0 | ✅ | P0 | `transition-all=1`、缺 focus |
| `views/ChallengePlay.vue` | 702 | 1 | ✅ | P0 | 死按钮、缺 focus |
| `views/WeeklyReport.vue` | 1400 | 0 | ✅ | P0 | 体量大、缺 focus |
| `views/LearningReportView.vue` | 448 | 0 | ❌(foc=3) | P1 | 已较好，少量补 hover 即可 |
| `views/LearningPrefs.vue` | 515 | 0 | ✅ | P1 | 缺 focus |
| `views/Achievement.vue` | 451 | 0 | ✅ | P2 | 偏展示 |
| `views/Certificate.vue` | 417 | 0 | ✅ | P2 | 偏展示 |
| `views/LearningMode.vue` | 437 | 0 | ✅ | P2 | `transition-all=2` |
